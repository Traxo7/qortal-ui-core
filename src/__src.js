...
const randomBase58Generator = api.randomBase58Generator


let str1 = randomBase58Generator(30)
let str2 = randomBase58Generator(30)
let str3 = randomBase58Generator(27)
let reference = str1 + str2 + str3
let tmstp = Date.now()
